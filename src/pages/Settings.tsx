...
function Settings() {
    ...
    const [dataDirPath, setDataDirPath] = useState<string>('~/.myproxy_manager/');
                        ...
                        <div className="flex flex-col h-full animate-in fade-in duration-500">
                            <div className="flex-1 flex flex-col justify-center items-center space-y-8">
                                ...
                                <div className="text-center space-y-4">
                                    ...
                                    <div>
                                        <h3 className="text-3xl font-black text-gray-900 dark:text-base-content tracking-tight mb-2">{t('common.app_name', 'MyProxy Manager')}</h3>
                                ...
                                <div className="w-full max-w-sm px-4">
                                    <a
                                        href="https://github.com/darkphenix2025-hue/MyProxy-Manager"
                                        target="_blank"
                                        rel="noreferrer"
