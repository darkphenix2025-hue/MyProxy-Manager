...
pub mod zai_vision_tools; // Built-in Vision MCP tools (z.ai vision API) // LLM logging

// 协议转换注册表 — 新的全对全转换架构（替代 Gemini 枢纽）
pub mod translator;
...
pub use config::ProviderDispatchMode;
#[allow(unused_imports)]
...
#[allow(unused_imports)]
pub use config::UpstreamProvider;
